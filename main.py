...
if __name__ == '__main__':
    ...
    parser.add_argument("--epochs", default=800, type=int)  # 轮次
    ...
    parser.add_argument("--out_dim", default=512, type=int)  # 要跟dim一样
    parser.add_argument("--dim", default=512, type=int)
    parser.add_argument("--GCNLayer", default=2, type=int)  # GAT输出维度 # default 64
    ...
    fprs, tprs, auc, precisions, recalls, prc = Train_multi(directory='data',  # 数据路径,相对路径即可，当前文件同级下的文件直接开头
                                                            ...
                                                            # feature_attn_size，元子图注意力层的特征输出维度
